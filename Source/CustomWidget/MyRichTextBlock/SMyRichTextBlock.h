 ...
 */
class CUSTOMWIDGET_API SMyRichTextBlock : public SWidget
{
	
public:

		SLATE_BEGIN_ARGS( SMyRichTextBlock )
		: _Text()
		, _HighlightText()
		, _WrapTextAt( 0.0f )
		, _AutoWrapText(false)
		...
		, _MinDesiredWidth()
	{
		...
		SMyRichTextBlock::FArguments& operator + (const TSharedRef< ITextDecorator >& DecoratorToAdd)
		{
