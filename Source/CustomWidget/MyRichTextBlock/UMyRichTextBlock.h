...
#include "CustomWidget/MyTextWidgetTypes/UMyTextWidgetTypes.h"
#include "Engine/DataTable.h"
#include "UMyRichTextBlock.generated.h"

class SMyRichTextBlock;
class UMyRichTextBlockDecorator;
class FSlateStyleSet;

/** Simple struct for rich text styles */
USTRUCT()
struct FMyRichTextStyleRow : public FTableRowBase
{
 ...
 */
UCLASS()
class CUSTOMWIDGET_API UMyRichTextBlock : public UMyTextLayoutWidget
{
	GENERATED_BODY()
...
public:
	UMyRichTextBlock(const FObjectInitializer& ObjectInitializer);
	...
	/**  */
	UFUNCTION(BlueprintCallable, Category = "Widget")
	UMyRichTextBlockDecorator* GetDecoratorByClass(TSubclassOf<UMyRichTextBlockDecorator> DecoratorClass);
...
protected:
	...
	/**  */
	UPROPERTY(EditAnywhere, Category=Appearance)
	TArray<TSubclassOf<UMyRichTextBlockDecorator>> DecoratorClasses;
	...
	UPROPERTY(Transient)
	TArray<UMyRichTextBlockDecorator*> InstanceDecorators;
	TSharedPtr<FSlateStyleSet> StyleInstance;
	TSharedPtr<SMyRichTextBlock> MyRichTextBlock;
};
