...
#include "UMyTextWidgetTypes.generated.h"
...
struct CUSTOMWIDGET_API FMyShapedTextOptions
{
	GENERATED_USTRUCT_BODY()

	FMyShapedTextOptions();
...
class CUSTOMWIDGET_API UMyTextLayoutWidget : public UWidget
{
...
protected:
	...
	FMyShapedTextOptions ShapedTextOptions;
