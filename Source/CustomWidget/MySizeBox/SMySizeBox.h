...
class CUSTOMWIDGET_API SMySizeBox : public SPanel
{
...
public:
	...
	/** Horizontal alignment of content in the area allotted to the SMySizeBox by its parent */
	SLATE_ARGUMENT(EHorizontalAlignment, HAlign)

	/** Vertical alignment of content in the area allotted to the SMySizeBox by its parent */
	SLATE_ARGUMENT(EVerticalAlignment, VAlign)

	/** Padding between the SMySizeBox and the content that it presents. Padding affects desired size. */
	SLATE_ATTRIBUTE(FMargin, Padding)

	/** The widget content presented by the SMySizeBox */
