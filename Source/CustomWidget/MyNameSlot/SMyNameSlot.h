...
/**
 * SMyNameSlot is the simplest layout element.
 */
class CUSTOMWIDGET_API SMyNameSlot : public SPanel
{
public:
	...
	/** Horizontal alignment of content in the area allotted to the SMyNameSlot by its parent */
	SLATE_ARGUMENT(EHorizontalAlignment, HAlign)

	/** Vertical alignment of content in the area allotted to the SMyNameSlot by its parent */
	SLATE_ARGUMENT(EVerticalAlignment, VAlign)

	/** Padding between the SMyNameSlot and the content that it presents. Padding affects desired size. */
	SLATE_ATTRIBUTE(FMargin, Padding)

	/** The widget content presented by the SMyNameSlot */
