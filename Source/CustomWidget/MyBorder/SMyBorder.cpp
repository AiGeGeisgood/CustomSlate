...
static FName SBorderTypeName("SMyBorder");
...
void SMyBorder::Construct( const SMyBorder::FArguments& InArgs )
{
	// Only do this if we're exactly an SMyBorder
...
void SMyBorder::SetContent( TSharedRef< SWidget > InContent )
{
	ChildSlot
	[
		InContent
...
const TSharedRef< SWidget >& SMyBorder::GetContent() const
{
	return ChildSlot.GetWidget();
}

void SMyBorder::ClearContent()
{
...
void SMyBorder::SetVAlign(EVerticalAlignment VAlign)
{
...
void SMyBorder::SetPadding(const TAttribute<FMargin>& InPadding)
{
	SetAttribute(ChildSlot.SlotPadding, InPadding, EInvalidateWidgetReason::Layout);
}

void SMyBorder::SetShowEffectWhenDisabled(const TAttribute<bool>& InShowEffectWhenDisabled)
{
	SetAttribute(ShowDisabledEffect, InShowEffectWhenDisabled, EInvalidateWidgetReason::Paint);
}

void SMyBorder::SetBorderImage(const TAttribute<const FSlateBrush*>& InBorderImage)
{
